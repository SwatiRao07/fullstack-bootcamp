...
-- 2. Create a junction table task_tags
...
-- 3. Insert tags: "urgent", "home", "office"
INSERT INTO tags (name) VALUES ('urgent'), ('home'), ('office')
ON CONFLICT (name) DO NOTHING;

-- 4. Assign multiple tags to tasks through the junction table
...
-- 5. Query all tasks with their associated tag names
